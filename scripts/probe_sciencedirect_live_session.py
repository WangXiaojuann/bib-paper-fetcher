"""Probe a live ScienceDirect Edge session and report whether PDF access signals are visible."""
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Probe a live ScienceDirect Edge session and report whether PDF access signals are visible.",
        formatter_class=argparse.ArgumentDefaultsHelpFormatter,
    )
    parser.add_argument("--debugger-address", default="127.0.0.1:9222", help="Edge remote-debugging address")
    parser.add_argument(
        "--url",
        default="https://www.sciencedirect.com/science/article/pii/S0886779824005960?via%3Dihub",
        help="Representative ScienceDirect article URL to probe",
    )
    parser.add_argument("--out-json", default="", help="Optional JSON file to write the probe result to")
